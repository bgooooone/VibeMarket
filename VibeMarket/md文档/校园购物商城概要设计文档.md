...
| **AI助手模块** | 智能聊天、购物建议 | Vue组件、Pinia、DashScope API |
...
| **AI助手模块** | AI聊天、购物建议、历史记录管理 | com.shopping.ai |
...
#### 4.1.6 AI助手相关
- **AiChatHistory**：AI聊天历史实体类
  - id：历史记录ID
  - userId：用户ID
  - message：用户消息
  - aiResponse：AI响应
  - sessionId：会话ID
  - messageType：消息类型（1-聊天，2-购物建议）
  - createTime：创建时间
  - updateTime：更新时间
...
#### 4.2.7 AI助手服务
- **AiAssistantService**：AI助手服务接口
- **AiAssistantServiceImpl**：AI助手服务实现类
...
- **AiChatHistoryMapper**：AI聊天历史数据访问接口
...
- **GET /api/v1/ai/advice**：获取购物建议
- **GET /api/v1/ai/history**：获取聊天历史记录
