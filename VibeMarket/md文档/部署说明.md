...
# AI助手配置（DashScope API）
ALIBABA_DASHSCOPE_API_KEY=your_dashscope_api_key
ALIBABA_DASHSCOPE_MODEL=qwen-max
ALIBABA_DASHSCOPE_BASE_URL=https://dashscope.aliyuncs.com/api/v1/services/aigc/text-generation/generation
...
services:
  ...
  backend:
    ...
    environment:
      ...
      ALIBABA_DASHSCOPE_MODEL: ${ALIBABA_DASHSCOPE_MODEL}
      ALIBABA_DASHSCOPE_BASE_URL: ${ALIBABA_DASHSCOPE_BASE_URL}
    volumes:
...
| ALIBABA_DASHSCOPE_API_KEY | DashScope API密钥 | - |
| ALIBABA_DASHSCOPE_MODEL | AI模型名称 | qwen-max |
| ALIBABA_DASHSCOPE_BASE_URL | API基础地址 | https://dashscope.aliyuncs.com/api/v1/services/aigc/text-generation/generation |
