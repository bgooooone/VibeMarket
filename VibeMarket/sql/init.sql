...
('admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iwK8pJwC', '系统管理员', 1);
...
-- 插入示例商品
INSERT INTO `product` (`name`, `category_id`, `price`, `original_price`, `stock`, `sales`, `description`, `main_image`, `status`) VALUES
('笔记本', 5, 15.00, 20.00, 100, 0, '优质笔记本，适合学习使用', '/images/notebook.jpg', 1),
('教材-高等数学', 6, 45.00, 50.00, 50, 0, '高等数学教材，全新', '/images/math.jpg', 1),
('洗发水', 7, 35.00, 40.00, 80, 0, '品牌洗发水，500ml', '/images/shampoo.jpg', 1),
('方便面', 8, 5.00, 6.00, 200, 0, '方便面，多种口味', '/images/noodles.jpg', 1),
('智能手机', 9, 1999.00, 2499.00, 30, 0, '品牌智能手机，64GB', '/images/phone.jpg', 1),
('笔记本电脑', 10, 4999.00, 5999.00, 20, 0, '高性能笔记本电脑', '/images/laptop.jpg', 1);
